...
const API_URLS = {
  auth: 'https://foodix.dynac.space:3000/auth-proxy/api',
  admin: 'https://foodix.dynac.space:3000/admin-proxy/api',
  delivery: 'https://foodix.dynac.space:3000/delivery-proxy/api',
  order: 'https://foodix.dynac.space:3000/order-proxy/api',
  payment: 'https://foodix.dynac.space:3000/payment-proxy/api',
  restaurant: 'https://foodix.dynac.space:3000/restaurent-proxy/api',
  notification: 'https://foodix.dynac.space:3000/notification-proxy/api',
};
