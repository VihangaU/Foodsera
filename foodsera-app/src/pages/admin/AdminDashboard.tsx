      ...
      <div className="bg-gray-900 text-white p-4 hidden md:block">
        ...
        <nav className="space-y-1">
          ...
          <Link 
            to="/admin/orders" 
            className={`flex items-center px-4 py-3 rounded-lg transition-colors ${
              pathname.includes("/admin/orders") ? "bg-gray-800 text-white" : "text-gray-300 hover:bg-gray-800 hover:text-white"
            }`}
          >
          ...
          <Link 
            to="/admin/menu" 
            className={`flex items-center px-4 py-3 rounded-lg transition-colors ${
              pathname.includes("/admin/menu") ? "bg-gray-800 text-white" : "text-gray-300 hover:bg-gray-800 hover:text-white"
            }`}
          >
