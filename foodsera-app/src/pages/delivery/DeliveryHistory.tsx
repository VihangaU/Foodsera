...
import { CheckCircle, Eye, MapPin, CreditCard, Clock, Calendar } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
    ...
    <div>
      ...
      {completedOrders.length === 0 ? (
        <div className="text-center py-10 bg-gray-50 rounded-lg">
          ...
          <h2 className="text-xl font-semibold mb-1">No completed deliveries</h2>
              ...
              <CardHeader className="bg-green-50 pb-2">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <CardDescription>{format(new Date(order.createdAt), 'MMM d, yyyy h:mm a')}</CardDescription>
                  </div>
